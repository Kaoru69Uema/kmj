...
//
		...
		if( t_tup( 0 ) ) {
			if( ( sw_click == 1 ) ) {
				...
				if( tone_no == 0 ) sound_ptn |= 0b1001000101000101;
			} else if( ( sw_click == 2 )  ) {
				sw_click = 0;
				repeat = 1;
				t_req( 1 );
