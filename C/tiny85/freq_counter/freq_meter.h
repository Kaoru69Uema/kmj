...
* 支援メール		: avr@atmel.com
*
* 支援デバイス	: The example is written for the ATTiny861, ATmega48_88_168
*
 ...
 * 590バイトのプログラム用フラッシュ メモリ、6バイトのSRAM
 *
...
#if defined(__AVR_ATtiny85__) | defined(__AVR_ATtiny461__) | defined(__AVR_ATtiny861__)	// これはGCCで動きます。
